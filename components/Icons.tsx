...
// A generic Icon component prop type
...
export const Twitter: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3 7.1 0 .8-.4 1.5-.9 2.2-1 .9-2.2 1.4-3.5 1.5-1.3 .2-2.7-.2-4-.8-1.3-.7-2.5-1.7-3.5-3-1-1.3-2-2.8-2.6-4.4-1.3-3.6-2.5-5.5-3.8-6.3-1.2-.8-2.6-.8-3.7-.1C2.3 4.9 1.4 6.5 2.3 8.4c.8 1.8 2.3 3.3 4.3 4.3 1.5.8 3.1 1.1 4.7.9 1.6-.2 3.1-.9 4.3-2 1.2-1.1 2-2.5 2.5-4.1.2-1 .3-2.1.2-3.2-.1-.9-.3-1.8-.5-2.6z"></path></svg>
);
